...
const Contact = () => {
  return (
    <section id="contact">
      <div
        className="min-h-auto bg-cover bg-center bg-no-repeat flex justify-center items-center bg-black/30"
        style={{
          backgroundImage: "url('/contactus.gif')",
        }}
      >
        <div className="w-full py-16 md:py-20">
          ...
          <div className="max-w-7xl mx-auto px-4 text-white w-full mt-10 sm:mt-16">
            <div className="w-full flex flex-col lg:flex-row p-4 justify-between gap-8">
              ...
              <div className="w-full lg:w-1/2 border border-blue-600 flex items-center justify-center rounded-4xl p-4">
                <div className="flex flex-col gap-6 justify-center items-start w-full">
                  ...
                  <div className="flex flex-row gap-3">
                    ...
                    <div>
                      <p className="text-2xl md:text-3xl font-bold text-[#00BCD5]">
                        Venue
                      </p>
                      <p className="lg:text-base text-sm">
                        IIT(ISM) Dhanbad, April 6-7th, 2026
                  ...
                  <div className="flex flex-row gap-3">
                    ...
                    <div>
                      ...
                      <p className="lg:text-base text-sm break-all">
                        iinventiv2026@iitism.ac.in
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Social Icons */}
                  <div className="w-full flex justify-center  px-4 sm:px-8 py-4 border border-blue-500 rounded-2xl bg-blue-800/40 flex-wrap gap-6 mt-4">
                    <a
                      href="https://x.com/iinventiv2026"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-slate-50 rounded-full p-2 hover:scale-110 transition"
                    >
                      <Twitter color={"#000000"} width={20} height={20} />
                    </a>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-white rounded-full flex items-center justify-center hover:scale-110 transition"
                    >
                      <InstaIcon width={36} height={24} />
                    </a>
                  </div>
              ...
              {/* RIGHT SECTION */}
              <div className="w-full lg:w-1/2 border border-blue-600 rounded-4xl overflow-hidden opacity-90">
                <img
                  src="/contactus_card.gif"
                  alt=""
